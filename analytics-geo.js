// Generated from the IANA time zone database (zone.tab + backward aliases).
// Maps IANA time zone names to ISO 3166-1 alpha-2 country codes, letting the
// extension report coarse (country-level) geography to GA4 via user_location
// without any network lookups. Regenerate from https://data.iana.org/time-zones/
// when zones change (rare, and stale entries only misplace edge-case zones).
var TZ_COUNTRIES = {
	"Africa/Abidjan":"CI",
	"Africa/Accra":"GH",
